...
@section('content')
<div id="vpscarousel" class="carousel slide" data-ride="carousel">
    <ol class="carousel-indicators">
        <li data-target="#vpscarousel" data-slide-to="0" class="active"></li>
        <li data-target="#vpscarousel" data-slide-to="1"></li>
        <li data-target="#vpscarousel" data-slide-to="2"></li>
    </ol>
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <img src="{{asset('images/new.png')}}" data-src="{{asset('images/new.png')}}" class="img-fluid">
        </div>
    ...
    <a class="carousel-control-prev" href="#vpscarousel" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#vpscarousel" role="button" data-slide="next">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 col-sm-12 pt-2 pl-md-5 pl-0 text-md-left text-center pr-0">
                    <div class="border-bottom px-lg-5">
                        <h5 class="font-weight-bold text-theme">Message of The Honorable Chairman</h5>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-7 col-sm-12 pt-2 pr-md-5 pr-0 order-md-1 order-sm-2 order-2 text-md-left text-center pl-0">
                    <div class="border-bottom">
                        <h5 class="font-weight-bold text-theme">History of Victoria Public School</h5>
                    </div>
                    <div class="py-3">
